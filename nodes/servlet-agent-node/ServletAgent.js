...
module.exports = function(RED){                                             // Export the function that defines the agent node.
    function ServletAgentNode(config){                                      // This function is the definition of the agent node. It takes a config object as a parameter.
    ...
    RED.nodes.registerType("ServletAgent",ServletAgentNode);                // This line of code registers the agent node with the name "ServletAgent".
}