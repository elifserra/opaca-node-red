...
module.exports = function(RED){                                                       // Export the function that defines the agent
    function BaseAgent(config){                                                       // This function is the definition of the agent node. It takes a config object as a
    ...
    RED.nodes.registerType("BaseAgent",BaseAgent);                                    // This line of code registers the agent node with the name "BaseAgent".
}