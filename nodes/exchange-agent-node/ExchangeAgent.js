...
module.exports = function(RED){                                                 // Export the function that defines
    function ExchangeAgentNode(config){                                           // This function is the definition of the agent node. It takes a config object as a parameter.
    ...
    RED.nodes.registerType("ExchangeAgent",ExchangeAgentNode);                      // This line of code registers the agent node with the name "FridgeAgent".
}