...
module.exports = function(RED){                                             // Export the function that defines the agent node.
    function RoomBookingAgentNode(config){                                  // This function is the definition of the agent node. It takes a config object as a parameter.
    ...
    RED.nodes.registerType("RoomBookingAgent",RoomBookingAgentNode);       // This line of code registers the agent node with the name "RoomBookingAgent".
}